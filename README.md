...
<div style="display: flex; flex-wrap: wrap; gap: 4px;">
  ...
  <img src="https://skillicons.dev/icons?i=fastapi" alt="FastAPI" style="height: 56px; cursor: pointer; transition: transform 0.5s;" />
  <img src="https://skillicons.dev/icons?i=graphql" alt="GraphQL" style="height: 56px; cursor: pointer; transition: transform 0.5s;" />
  <!-- Data -->
  ...
  <img src="https://skillicons.dev/icons?i=supabase" alt="Supabase" style="height: 56px; cursor: pointer; transition: transform 0.5s;" />
  <img src="https://skillicons.dev/icons?i=firebase" alt="Firebase" style="height: 56px; cursor: pointer; transition: transform 0.5s;" />
  <!-- DevOps & Tools -->
  <img src="https://skillicons.dev/icons?i=docker" alt="Docker" style="height: 56px; cursor: pointer; transition: transform 0.5s;" />
  <img src="https://skillicons.dev/icons?i=linux" alt="Linux" style="height: 56px; cursor: pointer; transition: transform 0.5s;" />
